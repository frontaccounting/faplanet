...
//                    $this->data_filter = $data->data_filter;
    ...
    function render($id, $title)
    {
        ...
        $sql = "SELECT * FROM ".TB_PREF."dashboard_reminders "
...
//            $sql .= ' AND '.$this->data_filter;
        ...
        {
        	if ($myrow['frequency'] == 'once') { // skip confirmed once remainders
				$param = json_decode(html_entity_decode($myrow['param']));
				if (!$param->occurrence) continue;
        	}
